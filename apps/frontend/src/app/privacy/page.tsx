    ...
    <div className="min-h-screen flex flex-col justify-between bg-slate-950 text-slate-100 font-sans">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 space-y-8 flex-1">
        <div className="space-y-3 border-b border-slate-900 pb-6">
          ...
          <p className="text-xs text-slate-400">Last Updated: July 23, 2026</p>
        </div>

        <div className="text-xs text-slate-300 leading-relaxed space-y-6">
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-white">3. Security Practices & Input Safeguards</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-base font-bold text-white">4. Data Sharing & Retention</h2>
            <p>
